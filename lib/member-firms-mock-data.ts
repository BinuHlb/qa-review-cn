...
export const mockMemberFirms: MemberFirm[] = [
  ...
  {
    id: "2",
    name: "HLB Global Office",
    email: "info@hlbglobal.com",
    status: "active",
    type: "current_member",
    location: "London, UK",
  ...
  {
    id: "3",
    name: "HLB Atectam & Partners (HLB Reunion)",
    email: "contact@hlbatectam.re",
    status: "active",
    type: "current_member",
  ...
  {
    id: "5",
    name: "Priego,Castro y Asoc, S.C. (HLB Mexico)",
    email: "contact@hlbmexico.com.mx",
    status: "pending",
    type: "prospect",
  ...
  {
    id: "7",
    name: "HLB Marka Audit (HLB Kyrgyz Republic)",
    email: "contact@hlbmarka.kg",
    status: "suspended",
    type: "prospect",
  ...
  {
    id: "8",
    name: "Financial Management Group (HLB Georgia)",
    email: "info@hlbgeorgia.ge",
    status: "active",
    type: "current_member",
  ...
  },
  {
    ...
    employeeCount: 55,
    partnerCount: 7,
    specializations: ["Audit & Assurance", "Tax Advisory", "Business Consulting", "Corporate Governance"],
    certifications: ["ISO 9001", "ACCA Approved"],
    contactPerson: "Sok Sophea",
    contactEmail: "sok.sophea@hlbcambodia.com.kh",
    contactPhone: "+855-23-456-789",
    website: "https://hlbcambodia.com.kh",
    ...
    complianceScore: 87,
    riskLevel: "low",
    description: "Professional accounting and audit firm serving the Cambodian market with international standards.",
